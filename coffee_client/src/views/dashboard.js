    ...
    return [
      ...
      m('.blurb',
        ...
        m('p',
          ...
          'example: tracking the provenance of coffee from catch to plate. ',
          'One day an application like this could be used by restaurants, ',
          'grocery stores, and their customers to ensure the coffee they ',
          'purchase is ethically sourced and properly transported.'),
        m('p',
          'To use ',
          m('em', 'CoffeeNet'),
          ', create an account using the link in the navbar above. ',
          'Once logged in, you will be able to add new coffee assets to ',
          ...
          'ownership or possession of the coffee entirely. For the ',
