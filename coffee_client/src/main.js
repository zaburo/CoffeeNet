...
const AddCoffeeForm = require('./views/add_coffee_form')
const AgentDetailPage = require('./views/agent_detail')
const AgentList = require('./views/list_agents')
const CoffeeList = require('./views/list_coffee')
const CoffeeDetail = require('./views/coffee_detail')
...
document.addEventListener('DOMContentLoaded', () => {
  m.route(document.querySelector('#app'), '/', {
    ...
    '/create': resolve(AddCoffeeForm, true),
    '/coffee/:recordId': resolve(CoffeeDetail),
    '/coffee': resolve(CoffeeList),
